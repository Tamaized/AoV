...
public class LightningStorm extends AbilityBase {
	...
	public boolean cast(Ability ability, PlayerEntity caster, LivingEntity target) {
		...
		caster.world.addEntity(storm);
		caster.world.playSound(null, storm.getPosX(), storm.getPosY(), storm.getPosZ(), SoundEvents.ENTITY_EVOKER_PREPARE_SUMMON, SoundCategory.PLAYERS, 4.0F, caster.getRNG().nextFloat() * 0.5F + 0.5F);
		return true;
	}
