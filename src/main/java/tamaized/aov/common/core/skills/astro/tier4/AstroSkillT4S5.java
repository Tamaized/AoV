...
public class AstroSkillT4S5 extends AoVSkill {
	...
	static {
		spells.add(Abilities.aspectedhelios);
	}

	public AstroSkillT4S5() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.tier4.5.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier4.5.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.tier4.5.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.aspectedhelios.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_3_5;
	}
