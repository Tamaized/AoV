...
public class AstroSkillT3S3 extends AoVSkill {
	...
	public AstroSkillT3S3() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.tier3.3.name"),

				new TextComponentTranslation("", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier3.3.req"),
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_2_3;
	}
