...
public class AstroSkillT4S3 extends AoVSkill {
	...
	public AstroSkillT4S3() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.tier4.3.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier4.3.req"),
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_3_3;
	}
