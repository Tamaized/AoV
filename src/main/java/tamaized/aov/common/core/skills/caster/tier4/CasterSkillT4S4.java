...
public class CasterSkillT4S4 extends AoVSkill {
	...
	static {
		spells.add(Abilities.leapOfFaith);
	}

	public CasterSkillT4S4() {
		super(spells,

				new TextComponentTranslation("aov.skill.caster.tier4.4.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.caster.tier4.4.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.leapOfFaith.getIcon();
	}
