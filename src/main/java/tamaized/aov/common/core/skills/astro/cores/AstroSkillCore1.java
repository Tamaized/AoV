...
public class AstroSkillCore1 extends AoVSkill {
	...
	public AstroSkillCore1() {
		super(spells,
				...
				new TextComponentTranslation("aov.skill.astro.core.1.name"),

				new TextComponentTranslation("aov.skill.global.core"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.core.1.desc")
