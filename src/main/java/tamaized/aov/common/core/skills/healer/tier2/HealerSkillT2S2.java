...
public class HealerSkillT2S2 extends AoVSkill {
	...
	static {
		spells.add(Abilities.cureWither);
	}

	public HealerSkillT2S2() {
		super(spells,

				new TextComponentTranslation("aov.skill.healer.tier2.2.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.healer.tier2.2.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.healer.tier2.2.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.cureWither.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.healer_tier_1_2;
	}
