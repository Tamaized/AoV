...
public class HealerSkillT3S1 extends AoVSkill {
	...
	static {
		spells.add(Abilities.cureCriticalWounds);
	}

	public HealerSkillT3S1() {
		super(spells,

				new TextComponentTranslation("aov.skill.healer.tier3.1.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.healer.tier3.1.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.healer.tier3.1.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.cureCriticalWounds.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.healer_tier_2_1;
	}
