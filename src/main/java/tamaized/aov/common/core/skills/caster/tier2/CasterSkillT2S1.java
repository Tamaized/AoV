...
public class CasterSkillT2S1 extends AoVSkill {
	...
	static {
		spells.add(Abilities.slayLiving);
	}

	public CasterSkillT2S1() {
		super(spells,

				new TextComponentTranslation("aov.skill.caster.tier2.1.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.caster.tier2.1.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.caster.tier2.1.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.slayLiving.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.caster_tier_1_1;
	}
