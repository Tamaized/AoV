...
public class DefenderSkillCore3 extends AoVSkill {
	...
	public DefenderSkillCore3() {
		super(spells,
				...
				new TextComponentTranslation("aov.skill.defender.core.3.name"),

				new TextComponentTranslation("aov.skill.defender.core.3.req"),

				new TextComponentTranslation("aov.skill.global.minlevel", LEVEL),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.defender.core.3.desc")
	...
	public AoVSkill getParent() {
		return AoVSkills.defender_core_2;
	}
