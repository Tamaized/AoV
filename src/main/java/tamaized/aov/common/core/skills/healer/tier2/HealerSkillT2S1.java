...
public class HealerSkillT2S1 extends AoVSkill {
	...
	static {
		spells.add(Abilities.cureSeriousWounds);
	}

	public HealerSkillT2S1() {
		super(spells,

				new TextComponentTranslation("aov.skill.healer.tier2.1.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.healer.tier2.1.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.healer.tier2.1.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.cureSeriousWounds.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.healer_tier_1_1;
	}
