...
public class AstroSkillT2S1 extends AoVSkill {
	...
	public AstroSkillT2S1() {
		super(spells,
				...
				new TextComponentTranslation("aov.skill.astro.tier2.1.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier2.1.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.tier2.1.desc")
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_1_1;
	}
