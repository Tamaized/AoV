...
public class DefenderSkillT2S3 extends AoVSkill {
	...
	public DefenderSkillT2S3() {
		super(spells,
				...
				new TextComponentTranslation("aov.skill.defender.tier2.3.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.defender.tier2.3.req"),
	...
	public AoVSkill getParent() {
		return AoVSkills.defender_tier_1_3;
	}
