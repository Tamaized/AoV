...
public class HealerSkillCore1 extends AoVSkill {
	...
	static {
		spells.add(Abilities.cureLightWounds);
	}

	public HealerSkillCore1() {
		super(spells,

				new TextComponentTranslation("aov.skill.healer.core.1.name"),
				...
				new TextComponentTranslation("aov.skill.healer.core.1.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.cureLightWounds.getIcon();
	}
