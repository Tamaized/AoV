...
public class AstroSkillCore4 extends AoVSkill {
	...
	static {
		spells.add(Abilities.redraw);
	}

	public AstroSkillCore4() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.core.4.name"),

				new TextComponentTranslation("aov.skill.astro.core.4.req"),

				new TextComponentTranslation("aov.skill.global.minlevel", LEVEL),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.core.4.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.redraw.getIcon();
	}
