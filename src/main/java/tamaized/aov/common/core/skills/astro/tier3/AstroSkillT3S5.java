package tamaized.aov.common.core.skills.astro.tier3;
...
public class AstroSkillT3S5 extends AoVSkill {
	...
	static {
		spells.add(Abilities.aspectedbenefic);
	}

	public AstroSkillT3S5() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.tier3.5.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier3.5.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.tier3.5.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.aspectedbenefic.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_2_5;
	}
