...
public class DefenderSkillT3S4 extends AoVSkill {
	...
	public DefenderSkillT3S4() {
		super(spells,
				...
				new TextComponentTranslation("aov.skill.defender.tier3.4.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.defender.tier3.4.req"),
	...
	public AoVSkill getParent() {
		return AoVSkills.defender_tier_2_4;
	}
