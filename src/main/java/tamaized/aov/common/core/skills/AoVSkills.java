...
public class AoVSkills {
	...
	public static void register() { // TODO: use IForgeRegistry
		...
		favoredsoul_capstone = register(new AoVSkill(new TextComponentTranslation("aov.skill.favoredsoul.core.5.name"), Abilities.archAngelicForm.getIcon(), 15, 0, 4, 1, 50, 0, 0, false, favoredsoul_core_4, Lists.newArrayList(Abilities.archAngelicForm)).setupTooltip(new TextComponentTranslation("aov.skill.favoredsoul.core.5.desc")));
		...
		/* Druid */
		druid_core_1 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.core.1.name"), SkillIcons.CENTERED, 0, 0, 0, 1, 0, 0, 0, true, null, Lists.newArrayList()).setupTooltip(new TextComponentTranslation("aov.skill.druid.core.1.desc")));
		...
		druid_core_3 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.core.3.name"), SkillIcons.DODGE, 6, 0, 0, 1, 0, 0, 0, false, druid_core_2, Lists.newArrayList()).setupTooltip(new TextComponentTranslation("aov.skill.druid.core.3.desc")));
		druid_core_4 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.core.4.name"), SkillIcons.CENTERED, 12, 0, 0, 1, 0, 0, 0, false, druid_core_3, Lists.newArrayList()).setupTooltip(new TextComponentTranslation("aov.skill.druid.core.4.desc")));
		druid_capstone = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.core.5.name"), SkillIcons.DODGE, 15, 0, 0, 1, 0, 0, 0, false, druid_core_4, Lists.newArrayList()).setupTooltip(new TextComponentTranslation("aov.skill.druid.core.5.desc")));
		...
		druid_tier_1_3 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.tier1.3.name"), SkillIcons.DODGE, 0, 1, 0, 1, 0, 1, 0, false, druid_core_1, Lists.newArrayList()).setupTooltip(null));
		...
		druid_tier_2_3 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.tier2.3.name"), SkillIcons.DODGE, 0, 4, 0, 1, 0, 1, 0, false, druid_tier_1_3, Lists.newArrayList()).setupTooltip(null));
		...
		druid_tier_3_3 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.tier3.3.name"), SkillIcons.DODGE, 0, 8, 0, 1, 0, 1, 0, false, druid_tier_2_3, Lists.newArrayList()).setupTooltip(null));
		...
		druid_tier_4_3 = register(new AoVSkill(new TextComponentTranslation("aov.skill.druid.tier4.3.name"), SkillIcons.DODGE, 0, 12, 0, 1, 0, 1, 0, false, druid_tier_3_3, Lists.newArrayList()).setupTooltip(null));
