...
public class AstroSkillT3S1 extends AoVSkill {
	...
	static {
		spells.add(Abilities.gravity);
	}

	public AstroSkillT3S1() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.tier3.1.name"),

				new TextComponentTranslation("aov.skill.global.minpoint", SPENT),

				new TextComponentTranslation("aov.skill.astro.tier3.1.req"),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.tier3.1.desc")
	...
	public ResourceLocation getIcon() {
		return Abilities.gravity.getIcon();
	}
	...
	public AoVSkill getParent() {
		return AoVSkills.astro_tier_2_1;
	}
