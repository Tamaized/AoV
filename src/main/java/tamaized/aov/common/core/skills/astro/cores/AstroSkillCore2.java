...
public class AstroSkillCore2 extends AoVSkill {
	...
	static {
		spells.add(AbilityBase.royalroad);
	}

	public AstroSkillCore2() {
		super(spells,

				new TextComponentTranslation("aov.skill.astro.core.2.name"),

				new TextComponentTranslation("aov.skill.astro.core.2.req"),

				new TextComponentTranslation("aov.skill.global.minlevel", LEVEL),

				new TextComponentTranslation(""),

				new TextComponentTranslation("aov.skill.astro.core.2.desc")
	...
	public ResourceLocation getIcon() {
		return AbilityBase.royalroad.getIcon();
	}
