...
public class Handwraps extends SwordItem {
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(@Nonnull EquipmentSlotType slot, ItemStack stack) {
		...
		if (slot == EquipmentSlotType.MAINHAND) {
			...
			multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(), new AttributeModifier(ATTACK_SPEED_MODIFIER, "Weapon modifier", CommonConfig.LOADED && AoV.config.handwrapsSpeed.get() ? 6F : 0F, AttributeModifier.Operation.ADDITION));
		}
