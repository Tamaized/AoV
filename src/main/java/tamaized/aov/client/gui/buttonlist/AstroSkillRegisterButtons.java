...
public class AstroSkillRegisterButtons implements IClassButtons {
	...
	public void register(AoVSkillsGUI instance) {
		...
		/* Cores */
		SkillButton sbI = new SkillButton(AoVSkillsGUI.getSkillButtonID(), instance.width / 2 - 63, instance.height - 48, AoVSkills.astro_core_1);
		instance.addNewButton(sbI);
		sbI = new SkillButton(AoVSkillsGUI.getSkillButtonID(), instance.width / 2 - 38, instance.height - 48, AoVSkills.astro_core_2);
		instance.addNewButton(sbI);
