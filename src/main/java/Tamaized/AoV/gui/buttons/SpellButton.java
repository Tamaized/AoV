...
public class SpellButton extends GuiButton{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY){
        if (this.visible){
            ...
            AoVUIBar.renderHotbarIcon(this, null, 0, xPosition+1, yPosition+1, 0, spell == null ? null : spell.getIcon(), false);
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5f, 0.5f, 0.0f);
            this.drawString(fontrenderer, spell.getName(), xPosition+85, yPosition*2 + 14, 0xFFFF00);
