...
public class DefenderSkillT4S4 extends AoVSkill {

	private static final ResourceLocation icon = new ResourceLocation(AoV.modid, "textures/skills/DefenderT4S4.png");
	...
	public AoVSkill getParent() {
		return AoVSkill.defender_tier_3_4;
	}
